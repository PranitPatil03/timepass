...
public class Science {
    ...
    public void WhatisScience(){
        System.out.println();
        System.out.println("What is Science – ??");
        System.out.println(
                ...
                "• The best advantage of taking science stream is, it keeps your options open. You might switch from science to commerce or science to arts.\n"+
    ...
    public void forwhowScienceis(){
        System.out.println();
        System.out.println("Who should take Science after 10th?");
        System.out.println("If technology fascinates you and you have a flair for numbers, then taking science after 10th would be a wise option. \n" +
                ...
                "- Now there are many students who don’t like Maths.\n" +
                "Either they are afraid of Maths or Maths doesn’t interest them. Don’t worry, if you want to become a" +
                "doctor, then knowing Maths is not necessary.You can easily opt for Physics, Chemistry, Biology (PCB).\n" +
